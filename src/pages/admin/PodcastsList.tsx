...
export default function PodcastsList() {
  ...
  return (
    <>
      <Helmet>
        <title>Podcasts | Admin | Cognitive Ledger</title>
      </Helmet>
      <AdminLayout>
        <div>
          <div className="flex items-center justify-between mb-6">
            <h1 className="headline-primary">Podcasts</h1>
            <Button asChild>
          ...
          {isLoading ? (
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-mono text-sm">
                            S{podcast.season_number || 1}E{podcast.episode_number || 1}
                          </span>
                        </div>
                      </TableCell>
                      <TableCell>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    ...
                                    podcast episode? This action cannot be undone.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
            ...
            <div className="text-center py-12 border rounded-lg">
              ...
              <Button asChild>
                <Link to="/admin/podcasts/new">Create your first episode</Link>
              </Button>
            </div>
          )}
        </div>
